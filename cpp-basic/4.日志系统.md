...
<img src="img/image-20231124114253211.png" alt="image-20231124114253211" style="zoom:80%;" />
...
>
> <img src="img/image-20231124150108405.png" alt="image-20231124150108405" style="zoom:80%;" />
>
> 
>
...
<img src="img/image-20231124171810154.png" alt="image-20231124171810154" style="zoom:80%;" />
...
<img src="img/undefined202403121545174.png" alt="image-20240312154513103" style="zoom:67%;" />

<img src="img/undefined202403121545477.png" alt="image-20240312154537422" style="zoom:67%;" />
...
```c++
// Mylogger.hpp
#ifndef __Mylogger__HH
#define __Mylogger__HH
...
: m_category(Category::getRoot())
{
    ...
    auto appender2 = new FileAppender{"default", "mylogger.log"};
    // 创建格式化器
...
int main(int argc, char * argv[]){
    ...
    cout << &(*Mylogger::getInstance()) << endl;
    cout << &(*Mylogger::getInstance()) << endl;
    string str = addPrefix("warn message");
    string str2 = addPrefix("hello world");
    Mylogger::getInstance()->warn(str.c_str());
    Mylogger::getInstance()->warn(str2.c_str());
    Mylogger::destoryInstacne();
    return 0;
}
...
<img src="img/undefined202403121547778.png" alt="image-20240312154756736" style="zoom:67%;" />
...
``` properties
# log4cpp.properties
# 根模块记录器 日志级别DEBUG 关联名为rootAppender的输出器
log4cpp.rootCategory=DEBUG, rootAppender 
# 子模块记录器sub1 关联2个输出器 名为A1 A2
log4cpp.category.sub1=DEBUG, A1, A2
# 子模块的子模块记录器sub1.sub2 关联名为A3的输出器
log4cpp.category.sub1.sub2=DEBUG, A3

# rootAppender配置 输出控制台
